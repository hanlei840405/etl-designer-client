    ...
    <q-form class="q-gutter-md">
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel name="main">
          ...
          <br/>
          <q-checkbox text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.clearRecords" label="在执行前清除结果行列表"/>
          <br/>
          <q-checkbox text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.clearFileRecords" label="在执行前清除结果文件列表"/>
          <br/>
          <q-checkbox text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.waitRemoteFinished" label="等待远程转换执行结束"/>
          <br/>
          <q-checkbox text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.notice" label="本地转换终止时远程转换也通知终止"/>
          <br/>
