    ...
    <q-form class="q-gutter-md">
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel name="main">
          ...
          <q-input outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.url" label="JMS URL"/>
          <br/>
          ...
          <q-input outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.destinationName" label="消息名称"/>
          <br/>
        ...
        <q-tab-panel name="batch">
          ...
          <br/>
          <q-input outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model.number="form.timeout" label="超时设置(ms)" hint="0不限制"/>
        </q-tab-panel>
