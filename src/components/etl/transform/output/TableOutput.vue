    ...
    <q-form class="q-gutter-md">
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel class="row q-col-gutter-xs" name="basic">
          ...
          <q-select class="col-12 col-md-6" outlined v-model.number="form.datasource" emit-value map-options option-value="id" :options="datasource" :label="$t('form.tableOutput.datasource')" clearable hint="">
