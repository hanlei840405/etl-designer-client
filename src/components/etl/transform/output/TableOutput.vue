    ...
    <q-form class="q-gutter-md">
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel class="row q-col-gutter-xs" name="basic">
          ...
          <q-input class="col-12 col-md-6" outlined type="number" min="0" v-model.number="form.commitSize" :label="$t('form.tableOutput.commitSize')" hint=""/>
        ...
        <q-tab-panel name="runningConfig">
          <q-input outlined v-model.number="form.parallel" :label="$t('form.tableOutput.threads')" type="number" min="1" :disable="forbiddenParallel"/>
        </q-tab-panel>
      </q-tab-panels>
