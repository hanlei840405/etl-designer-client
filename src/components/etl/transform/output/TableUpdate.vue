    ...
    <q-form class="q-gutter-md">
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel name="main">
          ...
          <q-checkbox outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.useBatchUpdate" label="批量更新"/>
          <q-checkbox outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.skipLookup" label="跳过查询"/>
          <q-checkbox outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.errorIgnore" :disable="form.skipLookup" label="忽略查询失败"/>
          <q-input outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.ignoreFlagField" label="忽略查询失败的标志字段" :disable="form.skipLookup && form.errorIgnore"/>
        </q-tab-panel>
