  ...
  <div style="width: 100%;">
    <q-form class="q-gutter-md">
      <q-tabs v-model="tab" class="text-grey" active-color="cyan-8" indicator-color="cyan-8" align="left" narrow-indicator>
        ...
        <q-tab name="field" :label="$t('tab-feild')" />
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel name="main">
          ...
          <q-checkbox outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.useBatchUpdate" :label="$t('form-use-batch')"/>
          <q-checkbox outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.skipLookup" :label="$t('form-skip-lookup')"/>
          <q-checkbox outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.errorIgnore" :disable="form.skipLookup" :label="$t('form-ignore-lookup-error')"/>
          <q-input outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.ignoreFlagField" :label="$t('form-flag-field')" :disable="form.skipLookup && form.errorIgnore"/>
        </q-tab-panel>
