                  ...
                  <q-tr :props="props">
                    <q-td key="operate" :props="props">
                      <q-btn size="xs" outline round color="negative" icon="remove"
                             @click="deleteSelect(props)"></q-btn>
                    </q-td>
                    ...
                    <q-td key="lengthValue" :props="props">
                      ...
                      <q-popup-edit v-model.number="props.row.lengthValue" :auto-save=true>
                        <q-input autofocus text-color="cyan-8" color="cyan-8" v-model.number="props.row.lengthValue"/>
                      </q-popup-edit>
                    </q-td>
                    <q-td key="accuracy" :props="props">
                      {{ props.row.accuracy }}
                      <q-popup-edit v-model.number="props.row.accuracy" :auto-save=true>
                        <q-input autofocus text-color="cyan-8" color="cyan-8" v-model.number="props.row.accuracy"/>
                      </q-popup-edit>
                    </q-td>
                  </q-tr>
                </template>
              ...
              <q-table :data="form.removes" :columns="removeColumns" :rows-per-page-options="[0]" row-key="name"
                ...
                <template v-slot:body="props">
                  <q-tr :props="props">
                    <q-td key="operate" :props="props">
                      <q-btn size="xs" outline round color="negative" icon="remove"
                             @click="deleteRemove(props)"></q-btn>
                    </q-td>
                    <q-td key="source" :props="props">
                      {{ props.row.source }}
                      <q-popup-edit v-model="props.row.source" :auto-save=true>
                        <q-select autofocus text-color="cyan-8" color="cyan-8" outlined v-model="props.row.source" :options="sourceFields"/>
                      </q-popup-edit>
                    </q-td>
                  </q-tr>
                </template>
                  ...
                  <q-tr :props="props">
                    ...
                    <q-td key="category" :props="props">
                      ...
                      <q-popup-edit v-model="props.row.category" :auto-save=true>
                        <q-select autofocus text-color="cyan-8" color="cyan-8" outlined v-model="props.row.category" :options="categories"/>
                      </q-popup-edit>
                    </q-td>
                    <q-td key="lengthValue" :props="props">
                      {{ props.row.lengthValue }}
                    ...
                    <q-td key="accuracy" :props="props">
                      ...
                      <q-popup-edit v-model="props.row.accuracy" :auto-save=true>
                        <q-input autofocus text-color="cyan-8" color="cyan-8" v-model="props.row.accuracy"/>
                      </q-popup-edit>
                    </q-td>
                    <q-td key="binary" :props="props">
                      {{ props.row.binary }}
                      <q-popup-edit v-model="props.row.binary" :auto-save=true>
                        <q-select autofocus text-color="cyan-8" color="cyan-8" outlined v-model="props.row.binary" :options="binaries"/>
                      </q-popup-edit>
                    </q-td>
                    <q-td key="formatValue" :props="props">
                      {{ props.row.formatValue }}
                      <q-popup-edit v-model="props.row.formatValue" :auto-save=true>
                        <q-select autofocus text-color="cyan-8" color="cyan-8" outlined v-model="props.row.formatValue" :options="formats"/>
                      </q-popup-edit>
                    </q-td>
                    <q-td key="dateFormatLenient" :props="props">
                      ...
                      <q-popup-edit v-model="props.row.dateFormatLenient" :auto-save=true>
                        <q-select autofocus text-color="cyan-8" color="cyan-8" outlined v-model="props.row.dateFormatLenient" :options="yesOrNo"/>
                      </q-popup-edit>
                    </q-td>
                    <q-td key="locale" :props="props">
                      {{ props.row.dateFormatLenient }}
                      <q-popup-edit v-model="props.row.dateFormatLenient" :auto-save=true>
                        <q-select autofocus text-color="cyan-8" color="cyan-8" outlined v-model="props.row.dateFormatLenient" clearable filled use-input
                    ...
                    <q-td key="encoding" :props="props">
                      ...
                      <q-popup-edit v-model="props.row.encoding" :auto-save=true>
                        <q-select autofocus text-color="cyan-8" color="cyan-8" outlined v-model="props.row.encoding" clearable filled use-input
                    ...
                    <q-td key="groupBy" :props="props">
                      ...
                      <q-popup-edit v-model="props.row.groupBy" :auto-save=true>
                        <q-input autofocus text-color="cyan-8" color="cyan-8" v-model="props.row.groupBy"/>
                      </q-popup-edit>
                    </q-td>
                    <q-td key="currency" :props="props">
                      {{ props.row.currency }}
                      <q-popup-edit v-model="props.row.currency" :auto-save=true>
                        <q-input autofocus text-color="cyan-8" color="cyan-8" v-model="props.row.currency"/>
                      </q-popup-edit>
                    </q-td>
                  </q-tr>
                </template>
