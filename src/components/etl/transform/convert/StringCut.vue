      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel name="main">
          ...
          <q-table :data="form.parameters" :columns="parameterColumns" :rows-per-page-options="[0]" row-key="name"
                   separator="cell" hide-bottom :title="$t('table-title-field-cut')">
              ...
              <q-tr :props="props">
                ...
                <q-td key="from" :props="props">
                  ...
                  <q-popup-edit v-model="props.row.from" :auto-save=true>
                    <q-input autofocus outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="props.row.from"/>
                  </q-popup-edit>
                </q-td>
                <q-td key="end" :props="props">
                  {{ props.row.end }}
                  <q-popup-edit v-model="props.row.end" :auto-save=true>
                    <q-input autofocus outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="props.row.end"/>
                  </q-popup-edit>
                </q-td>
              </q-tr>
            </template>
