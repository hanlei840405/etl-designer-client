    ...
    <q-form class="q-gutter-md">
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel name="main">
          ...
          <q-checkbox text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.useStorageValue" label="使用存储的记录值进行比较"/>
          <q-checkbox text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.useRedirect" label="重定向重复记录"/>
