    ...
    <q-form class="q-gutter-md">
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel class="row q-col-gutter-xs" name="basic">
          <q-input class="col-12 col-md-6" outlined v-model="form.name" :label="$t('form.dimensionLookup.name')" :rules="[ val => val && val.length > 0 || 'Please type something']" hint=""/>
          <q-select class="col-12 col-md-6" outlined v-model="form.datasource" emit-value map-options option-value="id" :options="datasourceOptions" :label="$t('form.dimensionLookup.datasource')" clearable hint="">
          ...
          <q-input class="col-12 col-md-6" outlined v-model="form.schemaName" :label="$t('form.dimensionLookup.schema')" :rules="[ val => val && val.length > 0 || 'Please type something']" hint=""/>
          <q-input class="col-12 col-md-6" outlined v-model="form.tableName" :label="$t('form.dimensionLookup.table')" :rules="[ val => val && val.length > 0 || 'Please type something']" hint="">
          ...
          <q-checkbox class="col-12 col-md-10" outlined v-model="form.preloadingCache" :label="$t('form.dimensionLookup.preloadingCache')" hint="" :disable="form.update"/>
          <q-input class="col-12 col-md-6" outlined type="number" v-model.number="form.cacheSize" :label="$t('form.dimensionLookup.cacheSize')" :disable="form.preloadingCache" hint="-1: without cache, 0: cache all"/>
          <q-input class="col-12 col-md-6" outlined type="number" v-model.number="form.commitSize" :label="$t('form.dimensionLookup.commitSize')" min="1" :disable="!form.update" hint=""/>
          <q-select class="col-12 col-md-6" autofocus outlined v-model="form.key" :options="targetFields" :label="$t('form.dimensionLookup.key')" hint=""/>
          <q-input class="col-12 col-md-6" outlined v-model="form.keyRename" :label="$t('form.dimensionLookup.keyRename')" :disable="form.update" hint=""/>
          <q-select class="col-12 col-md-6" autofocus outlined emit-value map-options v-model="form.keyGenerateType" :options="keyGenerateTypeOptions" :label="$t('form.dimensionLookup.keyGenerateType.default')" hint=""/>
          <q-input class="col-12 col-md-6" outlined v-model="form.sequence" :label="$t('form.dimensionLookup.sequence')" :disable="form.keyGenerateType!=='CREATION_METHOD_SEQUENCE'" hint=""/>
          <q-select class="col-12 col-md-6" autofocus outlined v-model="form.versionField" :options="targetFields" :label="$t('form.dimensionLookup.versionField')" hint="" :disable="!form.update"/>
          <q-select class="col-12 col-md-6" autofocus outlined v-model="form.dateField" :options="sourceFields" :label="$t('form.dimensionLookup.dateField')" hint=""/>
          <q-select class="col-12 col-md-6" autofocus outlined v-model="form.dateFrom" :options="targetFields" :label="$t('form.dimensionLookup.dateFrom')" hint=""/>
          <q-input class="col-12 col-md-6" outlined type="number" v-model.number="form.minYear" :label="$t('form.dimensionLookup.minYear')" :disable="!form.update" hint=""/>
          <q-checkbox class="col-12 col-md-12" outlined v-model="form.useAltStartDate" :label="$t('form.dimensionLookup.useAltStartDate')" hint=""/>
          <q-select class="col-12 col-md-6" autofocus outlined emit-value map-options v-model="form.altStartDate" :options="altStartDateOptions" :label="$t('form.dimensionLookup.altStartDate')" hint="" :disable="!form.useAltStartDate"/>
          <q-select class="col-12 col-md-6" autofocus outlined v-model="form.altStartDateField" :options="targetFields" :label="$t('form.dimensionLookup.altStartDateField')" hint="" :disable="!form.useAltStartDate || (form.useAltStartDate && form.altStartDate!=='4')"/>
          <q-select class="col-12 col-md-6" autofocus outlined v-model="form.dateTo" :options="targetFields" :label="$t('form.dimensionLookup.dateTo')" hint=""/>
          <q-input class="col-12 col-md-6" outlined type="number" v-model.number="form.maxYear" :label="$t('form.dimensionLookup.maxYear')" :disable="!form.update" hint=""/>
        </q-tab-panel>
