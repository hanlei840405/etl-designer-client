<template>
  <div style="width: 100%;">
    <q-form class="q-gutter-md">
      <q-input outlined v-model="form.name" :label="$t('form.rowsFromResult.name')" :rules="[ val => val && val.length > 0 || 'Please type something']" hint=""/>
      <q-table :data="form.parameters" :columns="parameterColumns" :rows-per-page-options="[0]" row-key="name" separator="cell" hide-bottom :title="$t('form.rowsFromResult.tableField')">
  ...
  data () {
    return {
      ...
      parameterColumns: [
        {
          name: 'operate',
          label: this.$t('form.rowsFromResult.columnOperate'),
          field: 'operate',
          align: 'right',
        ...
        {
          name: 'field',
          label: this.$t('form.rowsFromResult.columnSourceField'),
          field: 'field',
          align: 'left',
        ...
        {
          name: 'category',
          label: this.$t('form.rowsFromResult.columnType'),
          field: 'category',
          align: 'left',
          headerStyle: 'width: 100px;'
        },
        {
          name: 'lengthValue',
          label: this.$t('form.rowsFromResult.columnLength'),
          field: 'lengthValue',
          align: 'left',
          headerStyle: 'width: 100px;'
        },
        {
          name: 'accuracy',
          label: this.$t('form.rowsFromResult.columnAccuracy'),
          field: 'accuracy',
          align: 'left',
          headerStyle: 'width: 100px;'
        }
