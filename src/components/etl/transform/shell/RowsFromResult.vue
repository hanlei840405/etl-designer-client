          ...
          <q-tr :props="props">
            ...
            <q-td key="category" :props="props">
              ...
              <q-popup-edit v-model="props.row.category" :auto-save=true>
                <q-select autofocus outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model.number="props.row.category" emit-value map-options :options="categories"/>
              </q-popup-edit>
            </q-td>
