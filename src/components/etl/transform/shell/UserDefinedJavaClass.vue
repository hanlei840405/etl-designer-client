              ...
              <q-tr :props="props">
                <q-td key="operate" :props="props">
                  <q-btn size="xs" outline round color="negative" icon="remove"
                         @click="deleteOutputField(props)"></q-btn>
                </q-td>
              ...
              <q-tr :props="props">
                <q-td key="operate" :props="props">
                  <q-btn size="xs" round color="negative" icon="remove"
                         @click="deleteJavaParam(props)"></q-btn>
                </q-td>
                <q-td key="tag" :props="props">
                  {{ props.row.tag }}
                  <q-popup-edit v-model="props.row.tag" :auto-save=true>
                    <q-input autofocus outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="props.row.tag"/>
                  </q-popup-edit>
                </q-td>
              ...
              <q-tr :props="props">
                ...
                <q-td key="step" :props="props">
                  ...
                  <q-popup-edit v-model="props.row.step" :auto-save=true>
                    <q-select autofocus outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="props.row.step" :options="previousSteps" emit-value map-options/>
                  </q-popup-edit>
                </q-td>
                <q-td key="description" :props="props">
                  {{ props.row.description }}
        ...
        <q-card-section class="items-center q-pb-none">
          ...
          <q-tab-panels v-model="helpDialog.tab" animated>
            ...
            <q-tab-panel name="input">
              <q-tree :nodes="sourceFields" node-key="label" selected-color="cyan-8"/>
            </q-tab-panel>
          </q-tab-panels>
        </q-card-section>
      </q-card>
