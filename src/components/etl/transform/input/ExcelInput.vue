    ...
    <q-form class="q-gutter-md">
      ...
      <q-tab-panels v-model="tab" animated>
        <q-tab-panel name="file">
          ...
          <br/>
          <q-input outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.regExclude" label="正则表达式(排除)"/>
          <br/>
          <q-input outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.password" label="文件密码"/>
          ...
          <q-select outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.sheet" clearable filled use-input :options="sheets" label="选择工作表" @input="selectedSheet"/>
        </q-tab-panel>
        <q-tab-panel name="content">
          <q-checkbox text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.header" label="显示头部" /> <q-checkbox v-model="form.notNull" label="非空记录" /> <q-checkbox v-model="form.pause" label="停在空记录" />
          <br/>
          <q-input outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model.number="form.limit" label="限制数"/>
          <br/>
          <q-select outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.encoding" clearable filled use-input @filter="filterEncoding" :options="copyEncodings" label="字符集编码"/>
          <q-checkbox text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="form.withFileName" label="添加文件名" /> <q-checkbox v-model="form.header" label="严格类型" />
          <br/>
              ...
              <q-tr :props="props">
                ...
                <q-td key="accuracy" :props="props">
                  ...
                  <q-popup-edit v-model="props.row.accuracy" :auto-save="true">
                    <q-input autofocus outlined text-color="cyan-8" color="cyan-8" label-color="cyan-8" v-model="props.row.accuracy"/>
                  </q-popup-edit>
                </q-td>
...
import { sheets, headers } from 'src/service/PreviewService'
export default {
  name: 'ExcelInputMeta',
  data () {
    return {
